...
<link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/1.10.16/css/jquery.dataTables.min.css"/>
 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Modul LHU
        <small>---------------</small>
      </h1>
    </section>
       ...
       <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>Masterppk/transfer"><i class="fa fa-plus"></i>Transfer LHU</a>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">LHU (Transfer)</h3>
                   ...
                   <tr>   
                      ...
                      <td> <?php echo $row->tgl_lhu ?></td>
                       ...
                       <td class="text-center">
                             ...
                             <a class="btn btn-sm btn-danger" href="<?php echo base_url().'Masterppk/printlhu/'.$row->row_id; ?>" data-userid="<?php echo $row->row_id; ?>" title="Print LHU"><i class="fa fa-print"></i></a>
                        </td>
                    <?php     
                        }
                    ?>            
