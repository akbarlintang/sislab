...
echo '  
  ...
  border-width: 5px;
    ...
    <tr><td align=LEFT width="40%" style="font-size:12px ;">Kepada :'.$tr_pelanggan[0]['nm_trader'].' </td><td></td><td align=LEFT style="font-size:12px;"font color="red">BALAI KARANTINA IKAN, PENGENDALIAN MUTU</td></tr>
    <tr><td align=LEFT style="font-size:12px;">Issued to :'.$tr_pelanggan[0]['nm_propinsi'].' </td><td></td><td align=Left style="font-size:12px;"font color="red">DAN KEAMANAN HASIL PERIKANAN SEMARANG</td></tr>
    <tr><td></td><td></td><td align=Left style="font-size:12px;"font color="blue">LABORATORIUM PENGUJI</td></tr>
    <tr><td></td><td></td></td><td align=Left style="font-size:10px;">Jl. Dr. Suratmo No. 28 Kembangarum Semarang</td></tr>
    <tr><td></td><td></td></td><td align=Left style="font-size:10px;">Telp. (024) 76671020, Fax (024) 3541769, email : lapor.bkipmsemarang@kkp.go.id</td></tr>
    <tr><td align=Left style="font-size:12px;"></td><td align=Left style="font-size:10px;"></td>website : http://kkp.go.id/bkipmsemarang</tr>
    </table>
    <br>
<hr width="50%" align="center" border-style="double">
    ...
    <table border=0  width="100%">
        ...
        <tr> <td align="center" style="font-size:10px;">:'.$tr_mst_fppc[0]['no_lhu'].'</td></tr>
    </table>
    ...
    <br>
     ...
     <td valign="top"width="10%" style="font-size:10px;">: '.$tr_pelanggan[0]['nm_trader'].'</td>
     <td valign="top" width="10%">Alamat <Br><i>Address</i> </td>
     <td valign="top"width="10%" style="font-size:10px;" >:'.$tr_pelanggan[0]['al_trader'].'</td>
     </tr>
     <tr><td valign="top" width="0%">Jenis Contoh <br><i>Type of sample(s)</i> </td>
     <td valign="top"width="10%" style="font-size:10px;">:'.$hasil_uji[0]->nm_lokal .'/<i>'.$hasil_uji[0]->nm_latin .'</i></td></tr>
     ...
     <td valign="top" width="10%" style="font-size:10px;">Tanggal Pengujian <br><i>Date of Analysis</i>  </td>
...
echo '
 ...
 <table border=0  width="200px" cellspacing="0" cellpadding="5" style="font-size:8px;">
     ...
     <br> kecuali secara lengkap dan seiijin tertulis Laboratorium Penguji Balai KIPM Semarang

<br><i>This report of analysis shall not be reproduced (copied)
     <Br> expect for the completed one and with the written permisssin from testing laboratory Balai KIPM Semarang<i></td>
     </td>
     </tr>
  ...
  <tr>
    ...
    <td >
        ...
        <table>
            <tr><td width="300px">Semarang,  '.$tanggalttd.'</td></tr>
...
$mpdf->setFooter('Page {PAGENO} of {nb} DP/5.10.4/Balai KIPM SMG;Rev 4;25 Januari 2019');
