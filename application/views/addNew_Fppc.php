                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input disabled type="text" class="form-control pull-right" name="fno_ppc" id="fno_ppc">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control pull-right" name="tgl_sampel" id="datemask2">
