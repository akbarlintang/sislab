<?php
$id_wadah = $infoWadah->id_wadah;
$nama_wadah = $infoWadah->nama_wadah;
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-users"></i> Wadah
            <small>Ubah Wadah</small>
        </h1>
    </section>
            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Masukkan Detail Wadah</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->

                    <form role="form" action="<?php echo base_url() ?>editWadah" method="post" id="editWadah" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="nama">Nama Wadah</label>
                                        <input type="text" class="form-control" id="nama_wadah" placeholder="nama wadah" name="nama_wadah" value="<?php echo $nama_wadah; ?>" maxlength="128">
                                        <input type="hidden" value="<?php echo $id_wadah; ?>" name="id_wadah" id="id_wadah" />
                                    </div>
                                </div>
                                <!-- <div class="col-md-6">
                                    <div class="form-group">
