...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Form Ruang LIngkup
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Ruang Lingkup </h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <?php $this->load->helper("form"); ?>
                    <form role="form" id="addUser" action="<?php echo base_url() ?>Ruanglingkup/addNew_Ruanglingkup" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                     <div class="form-group">
                                        ...
                                        "<?php echo set_value('frl',$idrl[0]['jml']); ?>" id="frl" name="frl" maxlength="12">
                                    </div>
                                    <div class="form-group">
                                        <label for="fname">Ruang Lingkup</label>
                                        <input type="text" class="form-control required" value="<?php echo set_value('fruanglingkup'); ?>" id="fruanglingkup" name="fruanglingkup" maxlength="128">
                                    </div>
                                </div>
                            </div>
