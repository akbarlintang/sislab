              ...
              ?>
                  <tr>
                    ...
                    <td class="text-center">
                      <a class="btn btn-sm btn-warning" href="<?php echo base_url(); ?>Penilaian/addNew_Form_Nilai/<?php echo $record->row_id; ?>/<?php echo $record->id_kd_lokal; ?>" title="Nilai"><i class="fa fa-pencil"></i></a>
