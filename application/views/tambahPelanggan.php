        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="tambahPelanggan" action="<?php echo base_url() ?>tambahPelangganBaru" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="nama">Nama Lengkap</label>
                                        <input type="text" class="form-control required" value="<?php echo set_value('nama'); ?>" id="nama" name="nama" maxlength="128">
                                    </div>
