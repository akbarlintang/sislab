...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-users"></i> Penilaian Permohonan
      <!-- <small>---------------</small> -->
    </h1>
  </section>
                ...
                ?>
                    <tr>
                      ...
                      <td class="text-center">
                        <a class="btn btn-sm btn-info" href="<?php echo base_url(); ?>Penilaian/detail/<?php echo $record->row_id; ?>" title="Lihat Detail Permohonan"><i class="fa fa-search"></i></a>
