<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-users"></i>  Detail Hasil Pemeriksaan Contoh Uji
    </h1>
  </section>
            ...
            <table id="book-table" class="table table-hover">
              ...
              ?>
                  <tr>
                    ...
                    <td><?php echo $record->hasil_uji ?></td>
                    <td><?php echo $record->hasil_uji_keterangan ?></td>

                    <td class="text-center">
                      <a class="btn btn-sm btn-warning" href="<?php echo base_url() . 'Laporanuji/addNew_Form_Detail_uji/' . $record->row_id . '/' . $record->id_kd_lokal . '/' . $record->kode_uji; ?>" title="Ubah Detail Uji"><i class="fa fa-pencil"></i></a>
