              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <?php $this->load->helper("form"); 
                     $no = $settinglhu[0]->no;
                     $nm_penandatangan = $settinglhu[0]->nm_penandatangan;
                     $pj_penandatangan = $settinglhu[0]->pj_penandatangan;
                     $nip = $settinglhu[0]->nip;       


                    ?>
                    <form role="form" id="addUser" action="<?php echo base_url() ?>Settinglhu/update_setingan" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">    
                                      <div class="form-group">
                                        <label for="fname">No ID</label>
                                       <input type="text" class="form-control required" value="<?php echo set_value('frow_id',$no); ?>" id="frow_id" name="frow_id" maxlength="128">
                                      </div>   
                                      
                                  <div class="form-group">
                                        <label for="fname">Nama</label>
                                        <input type="text" class="form-control required" value="<?php echo set_value('fnm',$nm_penandatangan); ?>" id="fnm" name="fnm" maxlength="128">
                                    </div>
                                   
                                    <div class="form-group">
                                        <label for="fname">Jabatan</label>
                                        <input type="text" class="form-control required" value="<?php echo set_value('fpj',$pj_penandatangan); ?>" id="fpj" name="fpj" maxlength="128">
                                    </div>

                                    <div class="form-group">
                                        <label for="fname">NIP</label>
                                        <input type="text" class="form-control required" value="<?php echo set_value('fnip',$nip); ?>" id="fnip" name="fnip" maxlength="128">
                                    </div>
