  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="#"><b><p style="color:white">Simulasi Tarif Pelayanan </p></b><br></a>
      </div><!-- /.login-logo -->
   ...
   <form role="form" id="addUser" action="<?php echo base_url() ?>Login/count" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-12">                                
                                    ...
                                    <div class="form-group">
                                        <label for="fname">KOMODITI</label>
                                        <select class="form-control select2"  name='komoditi[]' "
                                            style="width: 100%;">
                                               <?php 
                                               foreach ($tarif as $row) { ?>
                                                <option value="<?php echo $row->kd_tarif;?>"><?php echo $row->nm_umum;?></option>
                                                <?php } ?>
                                            </select>
                                    </div>
                                     <div class="form-group">
                                        <label for="fname">JUMLAH</label> 
                                        <input type="text" class="form-control pull-right" name="jumlah" id="fjumlah">
                                       
                                    </div>
                                    <div class="form-group">
                                        <label for="fname">PEMERIKSAAN LABORATORIUM/per Sampel</label>
                                        <select class="form-control select2"  multiple="multiple" name='tarif_lab[]' "
                                            style="width: 100%;">
                                               <?php 
                                               foreach ($tarif_lab as $row) { ?>
                                                <option value="<?php echo $row->kd_tarif;?>"><?php echo $row->jn_pemeriksaan;?></option>
                                                <?php } ?>
                                            </select>
                                    </div>
                                 
                                 <div class="form-group">
                                        <label for="fname">JENIS KEGIATAN</label>
                                        <select class="form-control select2"  name='tarif_kegiatan[]' "
                                            style="width: 100%;">
                                               <?php 
                                         
                                               foreach ($tarif_kegiatan as $row) { ?>
                                                <option value="<?php echo $row->kd_tarif;?>"><?php echo $row->jn_pemeriksaan;?></option>
                                                <?php } ?>
                                            </select>
                                    </div>
