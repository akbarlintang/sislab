<?php
$id_kode_asal = $infoKode_asal->id_kode_asal;
$kode_asal = $infoKode_asal->kode_asal;
$keterangan = $infoKode_asal->keterangan;
?>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" action="<?php echo base_url() ?>editKode_asal" method="post" id="editKode_asal" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="nama">Kode Asal</label>
                                        <input type="text" class="form-control" id="kode_asal" placeholder="Kode Asal" name="kode_asal" value="<?php echo $kode_asal; ?>" maxlength="128">
                                        <input type="hidden" value="<?php echo $id_kode_asal; ?>" name="id_kode_asal" id="id_kode_asal" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
