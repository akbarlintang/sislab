<?php
$fno_ppc = $tr_mst_fppc->no_fppc;
$tgl_sampel = $tr_mst_fppc->tgl_fppc;
$no_ppk = $tr_mst_fppc->no_ppk;
$id_ppk = $tr_mst_fppc->id_ppk;
$tgl_ppk = $tr_mst_fppc->tgl_ppk;
?>
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="box box-primary">
            ...
            <form role="form" id="addUser" action="<?php echo base_url() ?>Permohonanlab/edit_FPPC" method="post" role="form">
              <div class="box-body">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="fname">NO FPPC</label>
                      <input disabled type="text" class="form-control pull-right" name="fno_ppc" value="<?php echo $fno_ppc; ?>" id="fno_ppc">

                    </div>
                    <div class="form-group">
                      <label for="fname">NO PPK</label>
                      <select class="form-control select2" multiple="multiple" name='ppk[]' "
                                            style=" width: 100%;">
                        <?php
                        foreach ($mst_pelaporan as $row) { ?>
                          <option value="<?php echo $row->id_ppk; ?>"><?php echo $row->no_ppk; ?></option>
                        <?php } ?>
                      </select>
                    </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="fname">Tanggal Masuk Sampel</label>
                      <input type="text" class="form-control pull-right" name="tgl_sampel" value="<?php echo $tgl_sampel; ?>" id="datemask2">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select disabled class="form-control select2" multiple="multiple" name='jenissampel[]' "
                                            style=" width: 100%;">
                        <?php
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="fname">Pelanggan</label>
                      <select class="form-control select2" multiple="multiple" name='pelanggan[]' "
                                            style=" width: 100%;">
                        <?php
                        foreach ($tb_r_trader as $row) { ?>
                          <option value="<?php echo $row->id_trader; ?>"><?php echo $row->nm_trader; ?></option>
                        <?php } ?>
                      </select>
                    </div>
