  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <i class="fa fa-users"></i> Tambah Nomor dan Tanggal Laporan Hasil Uji
        <!-- <small>Deskripsi Contoh Uji Hasil Uji</small> -->
      </h1>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <form role="form" id="addUser" action="<?php echo base_url() ?>Laporanuji/update_no_lhu" method="post" role="form">
              <div class="box-body">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label for="fname">No LHU</label>
                      <input type="text" class="form-control required" value="<?php echo set_value('fnolhu', $no_lhu); ?>" id="fnolhu" name="fno_lhu" maxlength="128">
                    </div>

                    <div class="form-group">
                      <label for="fname">Tanggal LHU</label>
                      <input type="text" class="form-control required" value="<?php echo set_value('ftgllhu', $tgl_lhu); ?>" id="ftgllhu" name="ftgl_lhu" maxlength="128">
                    </div>
