            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="addUser" action="<?php echo base_url() ?>SKHS/add_skhs_tambah" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6"> 
                                     <div class="form-group">
                                        <input type="hidden" class="form-control pull-right" name="fid_upi" style="width: 60%;" id="fid_upi" enabled="true" value="<?php echo $id_upi; ?>"  >
                                          
                                        <label for="fname">No SKHS</label>
                                          <input type="text" class="form-control pull-right" name="fno_skhs" style="width: 30%;" id="fno_skhs" enabled="true" />
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                             <div class="input-group-addon">
                                               ...
                                               <input type="text" class="form-control pull-right" name="ftgl_sertifikat" id="datemask2">
                                             </div>
                                    ...
                                    <div class="form-group">
                                        <label for="fname">Masa Berlaku  Sertifikat SKS</label>
                                            <select class="form-control select2" style="width: 20%;" name="fmasa_berlaku"  >
                                               <?php 
                                                    for ($j = 1; $j <= 12; $j++) {
...
<script>
  $(function () {
    ...
    //Datemask dd/mm/yyyy
    $('#datemask').inputmask('dd/mm/yy', { 'placeholder': 'dd/mm/yyyy' })
