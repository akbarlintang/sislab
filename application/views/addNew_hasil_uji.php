...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <i class="fa fa-users"></i> Ubah Detail Hasil Pemeriksaan Uji
        <!-- <small>Deskripsi Contoh Uji Hasil Uji</small> -->
      </h1>
    </section>
            ...
            <div class="col-md-6">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="addUser" action="<?php echo base_url() ?>Laporanuji/update_hasil_uji" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">    
                                      ...
                                      <div class="form-group">
                                       ...
                                       <input type="text" class="form-control required" value="<?php echo set_value('fdata_ikan',$data_ikan); ?>" id="fdata_ikan" name="fdata_ikan" maxlength="128">
                                      </div>   

                                    <div class="form-group">
                                        <label for="fname">Kode Parameter Uji</label>
                                       <input type="text" class="form-control required" value="<?php echo set_value('fdata_uji',$parameter_uji); ?>" id="fdata_uji" name="fdata_uji" maxlength="128">
                                    </div>
                                     <div class="form-group">
                                        <label for="fkodesampel">KODE PELANGGAN</label>
                                        <input type="text" class="form-control required" value="<?php echo set_value('fkodepelanggan'); ?>" id="fkodepelanggan" name="fkodepelanggan" maxlength="128">
                                    </div>
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo set_value('fketeranganuji'); ?>" id="fketeranganuji" name="fketeranganuji" maxlength="128">
                                    </div>
